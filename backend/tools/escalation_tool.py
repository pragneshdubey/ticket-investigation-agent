...
def escalate_to_human(
    ...
    Complete READ-MODIFY-WRITE critical section protected by _escalation_lock.
    """
...
def record_human_review(
    ...
    Complete READ-VALIDATE-MODIFY-WRITE critical section protected by _escalation_lock.
    """
    with _escalation_lock:
        status_map = {
            "confirm": "completed",
        ...
        # Validate that the ticket is not already reviewed
